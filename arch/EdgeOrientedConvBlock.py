...
class Conv3X3(nn.Module):
    def __init__(self, inp_planes, out_planes, act_type='relu'):
        ...
        self.conv = torch.nn.Conv2d(self.inp_planes, self.out_planes, kernel_size=3, padding=1)
        self.act  = None
...
class ECB(nn.Module):
    def __init__(self, inp_planes, out_planes, depth_multiplier=2.0, act_type='relu', with_idt=False):
